import { IAuth, ISettings, ClientCredentialsAuth } from '../src/index';
...
// Instancing ClientCredentialsAuth class.
const authWrapper: IAuth = new ClientCredentialsAuth(settings);
